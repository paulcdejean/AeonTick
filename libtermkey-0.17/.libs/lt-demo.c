...
/* ./.libs/lt-demo.c - temporary wrapper executable for .libs/demo
   Generated by libtool (GNU libtool) 2.4.2

   The demo program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "demo"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# demo - temporary wrapper script for .libs/demo\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2\n", f);
  fputs ("#\n", f);
  fputs ("# The demo program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"demo:demo:${LINENO}: libtool wrapper (GNU libtool) 2.4.2\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"demo:demo:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"demo:demo:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
