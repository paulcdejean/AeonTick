...
/* ./.libs/lt-demo-glib.c - temporary wrapper executable for .libs/demo-glib
   Generated by libtool (GNU libtool) 2.4.2

   The demo-glib program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "demo-glib"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# demo-glib - temporary wrapper script for .libs/demo-glib\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2\n", f);
  fputs ("#\n", f);
  fputs ("# The demo-glib program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"demo-glib:demo-glib:${LINENO}: libtool wrapper (GNU libtool) 2.4.2\" 1", f);
  fputs (">&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"demo-glib:demo-glib:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"demo-glib:demo-glib:${LINENO}: newargv[0]: $progdir/$program\" 1>", f);
  fputs ("&2\n", f);
