...
/* ./.libs/lt-demo-async.c - temporary wrapper executable for .libs/demo-async
   Generated by libtool (GNU libtool) 2.4.2

   The demo-async program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "demo-async"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# demo-async - temporary wrapper script for .libs/demo-async\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2\n", f);
  fputs ("#\n", f);
  fputs ("# The demo-async program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("# script's /usr/bin/libtool value, followed by yes.\n", f);
  ...
  fputs ("    echo \"demo-async:demo-async:${LINENO}: libtool wrapper (GNU libtool) 2.4.2\"", f);
  fputs (" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"demo-async:demo-async:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"demo-async:demo-async:${LINENO}: newargv[0]: $progdir/$program\" ", f);
  fputs ("1>&2\n", f);
